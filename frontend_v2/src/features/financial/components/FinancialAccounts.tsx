  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground">
        These are the account details recorded from the case's financial
        sources. Open an account to see its transactions across all recorded
        dates.
      </p>
      <form
          ...
          {query.data.items.length === 0 && (
            <p>
              {search
                ...
                : "No financial accounts have been recorded yet. Import a statement from Transactions to add its account and payments."}
            </p>
          )}
