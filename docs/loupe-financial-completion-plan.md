...
- [ ] Finish the advanced candidate-review draft check, distinguishing its existing explicit statement draft-save controls from unfinished individual reading edits. Continue actual user-facing fixes and incoming acceptance feedback without repeating the completed suites.
