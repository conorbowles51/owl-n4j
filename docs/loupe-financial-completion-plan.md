...
- [ ] Check the remaining decision forms for draft loss, distinguishing their existing explicit draft-save controls from missing recovery. Continue actual user-facing fixes and incoming acceptance feedback without repeating the completed suites.
