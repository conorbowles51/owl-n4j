...
- [ ] Keep temporary profile-loading failures recoverable without deleting a valid sign-in; preserve expired-session and newer-login isolation.
- [ ] Finish the expanded other-evidence record view with recorded currencies, readable metadata and applicable controls.
