...
- [ ] Verify the deployed identifier and public assets after the automatic deployment poll. Record any authenticated deployed workflow that still requires team access.
