...
- Select up to 100 payments for a named selection. A statement supports up to 1,000 possible transactions. Payment graphs above 1,000 payments ask for a smaller scope. The tested 2,700-payment case remains available through tables, trends and complete exports.
