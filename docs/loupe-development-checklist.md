...
1. **Import financial transactions from PDFs — partial**
   - [x] Dense corrupt embedded text now triggers local OCR even with many words. Real56-page file recovers Payment History pages51–52with OCR provenance and unchanged source bytes;26engine tests pass. Exact OCR word geometry/review integration remains next.
