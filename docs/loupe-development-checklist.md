...
7. **Connect transactions and explain money movement — partial**
   ...
   - [ ] Offer broader automatic identity proposals for review, including ambiguous names and new imports; preserve investigator decisions rather than silently merging names.
