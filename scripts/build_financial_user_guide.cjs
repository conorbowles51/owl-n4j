...
</style></head><body><header><span>Loupe financial user guide</span><a href="#contents">Contents</a></header><main>${body}</main><footer>11 September 2026. Screenshots show synthetic development data. Keep the original exported case records separately from this guide.</footer></body></html>`;
