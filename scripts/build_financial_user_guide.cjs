...
</style></head><body><header><span>Loupe financial user guide</span><a href="#contents">Contents</a></header><main>${body}</main><footer>20 September 2026. Screenshots show light mode with synthetic development data. Keep the original exported case records separately from this guide.</footer></body></html>`;
