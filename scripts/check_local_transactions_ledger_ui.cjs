...
(async () => {
 ...
 try {
  ...
  await page.screenshot({path:'/tmp/loupe-neilbyrne-transactions-ledger-ui.png'});
  ...
  fs.writeFileSync(path.join(root,'data/local-runtime/transactions-ledger-ui-check.json'),JSON.stringify(report,null,2));
