...
def trace_asset_uses(uses, rows, calculations):
    ...
    for use in uses:
        ...
        weights = [draw.by_claim[claim].minor_units for claim in claims] + [
        ...
        result.append(dict(transaction_id=key,asset_label=use.asset_label,basis=use.basis,
            ...
            remaining_withdrawal_minor=str(int(row['amount_minor'])-asset_amount),
