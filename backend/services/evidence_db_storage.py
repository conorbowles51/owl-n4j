...
class EvidenceDBStorage:
    ...
    def _file_to_dict(ef: EvidenceFile) -> Dict[str, Any]:
        return {
            ...
            "summary": ef.summary,
            "summary_source": ef.summary_source,
            "summary_edited_by": ef.summary_edited_by,
            "summary_edited_at": ef.summary_edited_at.isoformat() if ef.summary_edited_at else None,
