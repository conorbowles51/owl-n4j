...
@pytest.mark.xfail(strict=True, reason="DKT-415: the answer is one undifferentiated blob of text")
...
@pytest.mark.xfail(strict=True, reason="DKT-415/DKT-414: material claims are not tied to the chunks that support them")
...
@pytest.mark.xfail(strict=True, reason="DKT-416: there is no unsupported marker anywhere in the response")
...
@pytest.mark.xfail(strict=True, reason="DKT-416: an unqualified absence-of-evidence claim passes through unflagged")
