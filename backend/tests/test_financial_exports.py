...
class PackageSurfaceTests(unittest.TestCase):
    def test_pdf_candidate_contracts_are_exported(self):
        for name in ("CandidateResolvedReading", "CandidateReviewRequest", "read_candidate_review", "review_candidate", "assess_candidate_amounts", "current_candidate_original", "CandidateStoreError", "store_pdf_candidates", "read_candidate_mapping", "list_candidate_mappings", "list_candidate_accounts", "list_candidate_sources", "read_candidate_source", "PdfMappingProposal", "PdfPendingCandidate", "bind_pdf_mapping",
