...
def db_schema(pg_url: str):
    ...
    if not pg_url.startswith("postgresql"):
        pytest.skip("DKT-446 database tests require a PostgreSQL TEST_DATABASE_URL")
    ...
    schema = f"test_dkt446_{os.getpid()}_{uuid.uuid4().hex[:8]}"
...
def pg_engine(pg_url: str, db_schema: str):
    ...
    import postgres.models  # noqa: F401 - registers model metadata
