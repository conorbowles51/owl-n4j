...
class EvidenceFile(Base, TimestampMixin):
    ...
    summary_source: Mapped[str] = mapped_column(String(16), nullable=False, default="ai", server_default="ai")
    summary_edited_by: Mapped[str | None] = mapped_column(String(255), nullable=True)
    summary_edited_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
