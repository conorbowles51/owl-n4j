...
import { Filter, ChevronDown, ChevronRight, X, Search, Plus } from 'lucide-react';
        ...
        >
          ...
          {!isExpanded && (
            <span className="text-xs text-light-500">
              ({selectedTypeCount}/{totalTypeCount} types, {selectedCatCount}/{totalCatCount} categories)
            </span>
          )}
        </div>
      </div>
